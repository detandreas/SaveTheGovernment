...
- **Εξοικείωση με το github** δειτε κανα βιντεακι στο youtube πχ https://www.youtube.com/watch?v=a9u2yZvsqHA ωστε να καταλάβετε πως λειτουργεί και τι προσφέρει.Να ξέρετε σίγουρα τι είναι :Repository,Branch,Pull Request(PR),Commit
