...
public final class Message {
    ...
    public static final String USERNAME_INVALID_CHARS_MESSAGE =
        "Invalid Username. Username must only contain letters and digits and underscores.";
    ...
    public static final String BUDGET_ITEM_CREATION_SUCCESS =
        "The requested budget item was not found. A new one has been created successfully.";
    // No Amount Change Message
    public static final String NO_AMOUNT_CHANGE_MESSAGE =
        "The entered amount is identical to the current value. No update was made.";
    ...
    public static final String REQUEST_ALREADY_RESOLVED_MESSAGE =
        "The change request with ID number %d has already been %s."; // APPROVED or REJECTED
    // Request Authority Message
    public static final String REQUEST_AUTHORITY_MESSAGE =
        "Only the Prime Minister has the authority to approve or reject change requests.";
}
