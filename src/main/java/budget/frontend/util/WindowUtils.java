...
public final class WindowUtils {
     ...
     * @param initializer A lambda to configure the controller before showing the window.
     * Accepts the Controller and the Stage as arguments.
     * @param <T>         The type of the Controller.
     * @return The controller instance after the window is closed, or null if loading failed.
     */
